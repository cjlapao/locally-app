    ...
    extend: {
      ...
      colors: {
        locally: {
          ...
          'header-background': colors.slate['100'],
          text: colors.slate['600'],
          'caption-text': colors.slate['500'],
          'link-text': colors.sky['700'],
          ...
          'primary-pressed-background': colors.sky['900'],
          'primary-disabled-background': colors.slate['400'],
          'status-info': colors.sky['700'],
          'status-info-background': colors.sky['100'],
          'status-success': colors.emerald['700'],
          'status-success-background': colors.emerald['100'],
          'status-warning': colors.yellow['700'],
          'status-warning-background': colors.yellow['100'],
          'status-important': colors.red['700'],
      ...
      collections: {
        locally: {
          icons: {
            ...
            back: {
              body: '<g fill="currentColor"><path d="M7 4.5V2L1 8L7.0001 14V11.5L4.5001 9H15V7H4.5L7 4.5Z"/></g>'
            }
          }
        }
      }
