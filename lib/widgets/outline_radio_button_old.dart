...
class OutlineRadioButtonOld extends StatefulWidget {
  ...
  @override
  State<OutlineRadioButtonOld> createState() => _OutlineRadioButtonState();
}

class _OutlineRadioButtonState extends State<OutlineRadioButtonOld> {
  int? _activeIndex = -1;
